...
// function MinimizedDFAGraphWithSimulation({ 
//   minimizedDfaString, 
//   currentState,
...
//       const dot = generateDotForMinimizedDFAWithSimulation(
//         minimizedDfaString, 
//         currentState, 
//         highlightedTransition
//       );
...
//       isMounted = false;
//     };
//   }, [minimizedDfaString, currentState, highlightedTransition]);
...
// function generateDotForMinimizedDFAWithSimulation(
//   input: string, 
//   currentState?: string,
//   highlightedTransition?: { from: string; to: string; label: string } | null
// ): string {
...
// // Main DFASimulator component
// export function DFASimulator({ 
//   minimizedDfaString, 
//   inputString, 
//   isOpen, 
//   onClose 
...
//   useEffect(() => {
//     if (!isOpen || !inputString) return;

//     const { transitions, finalStates, startState } = parseDFA(minimizedDfaString);
...
//   }, [isOpen, inputString, minimizedDfaString]);
...
//           {/* Graph Display */}
//           <div className="mb-6">
//             <MinimizedDFAGraphWithSimulation 
//               minimizedDfaString={minimizedDfaString}
