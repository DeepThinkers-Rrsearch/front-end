...
import { extractEpsilonNfaPrompt } from "../prompt_templates/text_extract_prompts";

export async function extractEpsilonNfaTextFromImage(imageFile: File): Promise<string> {
...
const message = new HumanMessage({
    content: [
      { type: "text", text: extractEpsilonNfaPrompt },
      {
        type: "image_url",
