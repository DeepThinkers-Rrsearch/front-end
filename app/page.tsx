...
export default function HomePage() {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    researchInterest: "DFA Minimization",
    message: "",
  });
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed"
